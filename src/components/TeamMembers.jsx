...
export default function TeamSection() {
  return (
    <section
      id="team-section"
      className="relative py-12 sm:py-16 md:py-24 overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative p-4 sm:p-6 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-300">
